# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-22 09:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='支付平台返回单号')),
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('await_pay', '待支付')], max_length=20, verbose_name='订单状态')),
